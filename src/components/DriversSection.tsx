...
export function DriversSection() {
  return (
    <section id="drivers" className="section-card scroll-mt-28 lg:scroll-mt-20">
      <div className="section-heading"><span>09</span><div><h2>Драйверы клиентского опыта</h2><p>После сравнения reactive vs predictive смотрим не просто на частоты, а на причины, которые объясняют управленческое действие: исключить, включить в care или развивать через cross-sell.</p></div></div>
