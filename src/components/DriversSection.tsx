...
export function DriversSection() {
  return (
    <section id="drivers" className="section-card scroll-mt-20">
      <div className="section-heading"><span>03</span><div><h2>Драйверы клиентского опыта</h2><p>Главная ценность модели — связка между причиной клиентского опыта, клиентской базой и управленческим действием.</p></div></div>
