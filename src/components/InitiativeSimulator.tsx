...
export function InitiativeSimulator() {
  ...
  return (
    <section id="simulator" className="section-card scroll-mt-20">
      <div className="section-heading"><span>06</span><div><h2>Симулятор инициатив</h2><p>Промоутеры и клиенты с высоким потенциалом — приоритет для кросс-сейла, пилотов и реферальных механик. Рискованные базы исключаются до устранения причины негативного опыта.</p></div></div>
